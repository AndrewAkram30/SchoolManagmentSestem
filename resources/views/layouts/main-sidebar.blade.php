        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">المراحل الدراسيه</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'grade')) }}">قائمه المراحل الدراسيه </a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الصفوف الدراسيه</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'classroom')) }}">قائمه الصفوف الدراسيه</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'section')) }}">قائمه الاقسام الدراسيه</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'add_parent')) }}">اضافه والى الامر</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'list_parent')) }}">قائمه والى الامر</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label"> المعلمون</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'teatchers')) }}">قائمه المعلمون</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('students.create') }}">اضافه طالب </a></li>
                    <li><a class="slide-item" href="{{ route('students.index') }}">قائمه الطلاب</a></li>
                    <li><a class="slide-item" href="{{ route('student_promotions.index') }}"> ترقيه الطلاب
                        </a>
                    </li>
                    <li><a class="slide-item" href="{{ route('student_promotions.create') }}"> قائمه ترقيه الطلاب
                        </a>
                    <li><a class="slide-item" href="{{ route('fees.create') }}">مصروفات الطلاب </a>
                    </li>
                    <li><a class="slide-item" href="{{ route('fees_invoices.index') }}"> فواتير الطلاب </a>
                    </li>
                    <li><a class="slide-item" href="{{ route('reciptstudent.index') }}"> any</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('payment_student.index') }}"> دفع الطالب</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الاداراه</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('attendance_student.index') }}">الغياب </a>
                    </li>
                    <li><a class="slide-item" href="{{ route('subject_student.index') }}">مواد الطلاب</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الامتحانات </span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('quiz_student.index') }}">كويزات </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'table-data')) }}">Data Tables</a></li>
                </ul>
            </li>


            <li class="side-item side-item-category">المكتبات</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('library_student.index') }}">قائمه الكتب</a></li>
            ...
            <!-- Settings-->
            <li>
                <a href="{{ route('setting.index') }}"><i class="fas fa-cogs"></i><span class="right-nav-text">
                        الاعدادات </span></a>
            </li>
