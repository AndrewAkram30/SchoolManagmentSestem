        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('library_student.create') }}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <tbody>
                                        @foreach ($Library as $book)
                                            <tr>
                                                ...
                                                <td>{{ $book->title }}</td>
                                                <td>{{ $book->Teatchers->Name }}</td>
                                                <td>{{ $book->Grades->Names }}</td>
                                                <td>{{ $book->Classrooms->Name_Class }}</td>
